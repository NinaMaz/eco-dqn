...
from src.agents.dqn.ppo import PPO
from src.agents.dqn.sac import SAC
...
def run(save_loc="ER_20spin/eco_sac32", minibatch_size = 32):
    ...
    network_fn = lambda: MPNN(n_obs_in=train_envs[0].observation_space.shape[1],
                              ...
                              tied_weights=False,
                              value_layer=True,
                              n_spins_train=train_envs[0].observation_space.shape[0])

    agent = SAC(train_envs,
